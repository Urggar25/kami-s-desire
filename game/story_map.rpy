    ...
    STORY_MAP_ROUTES = [
        {
            ...
            "nodes": [
                ...
                {"id": "D9_0_1", "title": "Jour 9", "label": "_9_0_1_REVEIL_CHAMBRE", "requires": ["D8_0_1"], "summary": "Kami revient après deux jours de silence et force le Conclave à voter sur les regroupements limenois aux frontières. Les représentants détournent un signal pour prévenir les campements avant le vote, mais Kami reprend la procédure et transforme leur sauvetage en humiliation publique."},
                {"id": "D10_0_1_0", "title": "Jour 10", "label": "_10_0_1_0_REVEIL_CHAMBRE", "requires": ["D9_0_1"], "summary": "Branche alternative du Jour 10 après l'échec du vote limenois. Le Conclave commence la journée sous le poids immédiat du Commandement IV."},
                {"id": "D10_0_1_1", "title": "Jour 10", "label": "_10_0_1_1_REVEIL_CHAMBRE", "requires": ["D9_0_1"], "summary": "Noam se réveille avec un mal de crâne inhabituel dans un Conclave trop chaud et trop silencieux. À la cafétéria, Elias annonce que la majorité des campements s'est dispersée à temps, mais Ryn explose en accusant Kami d'avoir piégé tout le monde."},
