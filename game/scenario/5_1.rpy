...
label _5_1_REVEIL_CHAMBRE:
    ...
    call MAYBE_PLAY_SCRIPTED_DOOR("couloir_dortoir", "couloir_dortoir") from _call_MAYBE_PLAY_SCRIPTED_DOOR_245
...
label _5_1_CAFETERIA_MATIN:
    ...
    call MAYBE_PLAY_SCRIPTED_DOOR("cafeteria", "bg_cafeteria") from _call_MAYBE_PLAY_SCRIPTED_DOOR_248
...
label _5_1_TEMPS_LIBRE:
    ...
    call MAYBE_PLAY_SCRIPTED_DOOR("couloir_cafeteria", "couloir_cafeteria") from _call_MAYBE_PLAY_SCRIPTED_DOOR_249
...
label _5_1_INFIRMERIE_KAEL:
    ...
    call MAYBE_PLAY_SCRIPTED_DOOR("infirmerie", "bg_infirmerie") from _call_MAYBE_PLAY_SCRIPTED_DOOR_251
    ...
    call MAYBE_PLAY_SCRIPTED_DOOR("couloir_infirmerie", "couloir_infirmerie") from _call_MAYBE_PLAY_SCRIPTED_DOOR_252
...
label _5_1_CHOIX_CHAMBRE:
    ...
    $ current_period = "Soir"
    call MAYBE_PLAY_SCRIPTED_DOOR("chambre", "bg_chambre") from _call_MAYBE_PLAY_SCRIPTED_DOOR_253
    scene bg_chambre at adaptive_fullscreen with dissolve
...
label _5_1_PHARMACIE:
    ...
    call MAYBE_PLAY_SCRIPTED_DOOR("couloir_infirmerie", "couloir_infirmerie") from _call_MAYBE_PLAY_SCRIPTED_DOOR_255
    scene couloir_infirmerie at adaptive_fullscreen with dissolve
    ...
    call MAYBE_PLAY_SCRIPTED_DOOR("infirmerie", "bg_infirmerie") from _call_MAYBE_PLAY_SCRIPTED_DOOR_256
    scene bg_infirmerie at adaptive_fullscreen with dissolve
    ...
    call MAYBE_PLAY_SCRIPTED_DOOR("couloir_infirmerie", "couloir_infirmerie") from _call_MAYBE_PLAY_SCRIPTED_DOOR_258
    scene couloir_infirmerie at adaptive_fullscreen with dissolve
    ...
    call MAYBE_PLAY_SCRIPTED_DOOR("chambre", "bg_chambre") from _call_MAYBE_PLAY_SCRIPTED_DOOR_259
    scene bg_chambre at adaptive_fullscreen with dissolve
