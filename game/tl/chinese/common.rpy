...
translate chinese strings:
    ...
    new "无障碍菜单。使用上下方向键导航，按 Enter 键启用按钮和滑块。"
    ...
    new "此菜单中的选项旨在改善无障碍体验。它们可能无法适用于所有游戏，某些选项组合甚至可能导致游戏无法正常游玩。这并非游戏或引擎本身的问题。更换字体时，为获得最佳效果，请尽量保持文本大小与原始设置一致。"
    ...
    new "确定要跳过未读对话并前往下一个选项吗？"

    # renpy/common/00gui.rpy:459
    old "This save was created on a different device. Maliciously constructed save files can harm your computer. Do you trust this save's creator and everyone who could have changed the file?"
    new "此存档是在另一台设备上创建的。恶意构造的存档文件可能会损害你的电脑。你是否信任此存档的创建者，以及所有可能修改过该文件的人？"

    # renpy/common/00gui.rpy:460
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "你是否信任创建此存档的设备？只有当你是该设备的唯一用户时，才应选择“是”。"
    ...
    new "本程序包含依据多种许可证发布的自由软件，其中包括 MIT License 和 GNU Lesser General Public License。完整的软件列表及其完整源代码链接可在{a=https://www.renpy.org/l/license}此处{/a}查看。"
    ...
    new "剪贴板朗读已启用。按 'shift+C' 可禁用。"

    # renpy/common/00preferences.rpy:703
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "自动朗读会读出“[renpy.display.tts.last]”。按 'alt+shift+V' 可禁用。"
    ...
    new "Ren'Py Sync 服务器上没有此同步数据的副本。同步 ID 可能无效，或同步数据已过期。"
    ...
    new "这将连接到 {a=https://sync.renpy.org}Ren'Py Sync 服务器{/a}。"
    ...
    new "你可以使用此 ID 在另一台设备上下载存档。\n此同步将在一小时后过期。\nRen'Py Sync 由 {a=https://www.renpy.org/sponsors.html}Ren'Py 赞助者{/a}提供支持。"
    ...
    new "第 [index] 张图片，共 [count] 张，尚未解锁。"
    ...
    new "将 traceback.txt 文件以 BBCode 格式复制到剪贴板，可用于 https://lemmasoft.renai.us/ 等论坛。"
    ...
    new "将 traceback.txt 文件以 Markdown 格式复制到剪贴板，可用于 Discord。"
    ...
    new "尝试回滚到较早的时间点，以便保存游戏或选择不同的选项。"
