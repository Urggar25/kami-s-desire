...
translate english strings:
    ...
    new "Quelle proposition Noam écrit-il ?"

    # game/scenario/1_canon.rpy:1599
    old "Limiter l’interdiction de transmission d’informations à la politique"
    new "Limiter l’interdiction de transmission d’informations à la politique"

    # game/scenario/1_canon.rpy:1599
    old "Instaurer une obligation d’assistance quand une aide est possible"
    new "Instaurer une obligation d’assistance quand une aide est possible"
    ...
    new "Se rendre à la salle de repos (Optionnel)"
